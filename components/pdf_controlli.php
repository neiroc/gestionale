...
// SQL Query  
$result = mysqli_query($con,"SELECT data, seq_inizio, seq_fine, pezzi_controllati, 
...
while($row = mysqli_fetch_array($result))
  ...
  $tbl .= '<tr style="background-color:'.$color_row.'"><td>'.$data.'</td><td>'.$cod_in.'</td><td>'.$cod_out.'</td><td>'.$controllati.'</td><td>'.$ok.'</td><td>'.$ko.'</td><td>'.$rilavorati.'</td></tr>';
}
